      ...
      <header class={styles.header}>
        <div class={styles.headerInner}>
          ...
          <div style={{ display: "flex", gap: "8px", "align-items": "center" }}>
            ...
            <button class={styles.mobileMenu} aria-label="Menu" style={{ border: "1px solid var(--border)", background: "white", padding: "8px 10px", "border-radius": "10px" } as any}>
              ☰
            </button>
          </div>
        </div>
        ...
        <div class={styles.container}>
          <div class={styles.heroInner}>
            <div class={styles.heroCopy}>
              <div style={{ display: "inline-flex", gap: "8px", "align-items": "center", background: "white", border: "1px solid var(--border)", padding: "6px 12px", "border-radius": "999px", "font-size": "12px", "font-weight": "700", "letter-spacing": "0.02em" } as any}>
